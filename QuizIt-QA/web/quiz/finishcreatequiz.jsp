...
<div class="container">
    ...
    <div class="starter-template">
        <div class="col-md-4 col-md-offset-4">
            <h1>Quiz Creator</h1>
            <form class="form-horizontal" id="questionform" action="/CreateQuizServlet" method="post">
                <div class="form-group">
                    <label for="quizname">Quiz Name</label>
                    <input type="text" id="quizname" name="quizname" class="form-control" placeholder="Pick a name">
                    <br>
                    <label for="quizdescription">Quiz Description</label>
                    <input type="text" id="quizdescription" name="quizdescription" class="form-control" placeholder="Describe your quiz">
                    <br>
